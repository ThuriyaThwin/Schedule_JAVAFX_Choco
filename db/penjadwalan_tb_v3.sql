...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`penjadwalan_tb`
...
insert  into `jadwal`(`id_jadwal`,`no_dosen`,`no_hari`,`no_sesi`,`no_matkul`,`no_kelas`) values 
(1,1,5,5,1,1),
(2,1,5,6,1,1),
(3,1,5,7,1,1),
(4,1,5,8,1,1),
...
CREATE TABLE `jadwal_temp` (
  `no` int(20) NOT NULL AUTO_INCREMENT,
  `dosen` varchar(225) DEFAULT NULL,
  `no_dosen` int(20) DEFAULT NULL,
...
/*Data for the table `jadwal_temp` */
